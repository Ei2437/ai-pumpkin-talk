...
VIDEO_ENTRY = "videos/Pumpkin-Entry.mov"      # 登場モーション
...
VIDEO_FINISH = "videos/Pumpkin-Finish.mov"    # 退場モーション
BACK_SPEED_SKIP = 10
...
# グローバル変数
a_key_active = False
state = "waiting"  # 初期状態を"waiting"に変更
...
if __name__=="__main__":
    main()TRANSITION_SPEED
            if videos["full4"].frame_accumulator >=