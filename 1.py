...
SOUND_FILES = {
    '4': [
        {"path": "sounds/初め1.wav", "subtitle": "お前ら、なんだか俺様と話したそうな顔してるな。まぁ、俺様の今日は気分がいいんだ。質問に答えてやろう。質問があるやつは手を挙げな！何人かの話を聞いてやる。"},
        {"path": "sounds/初め2.wav", "subtitle": "よぉ、お前ら。俺様の輝かしい姿を一目見ようと、ずいぶん早くから並んでたんだろ？ まぁ、気持ちはわかるぜ。今日は特別にお前らと話してやる。質問したいやつ、遠慮すんな。指名してやるから、精一杯手をあげろ！"},
        {"path": "sounds/初め3.wav", "subtitle": "ハハッ、今回も満員御礼ってわけか。さすが俺様だな。お前ら、ラッキーだぜ？ 今日の俺様は上機嫌なんだ。この貴重な時間を無駄にしたくねぇだろ？ 質問があるやつは今のうちだ。何人か選んでやるから、全力で手をあげな！"}
    ],
    '2': [
    ...
    '3': [
        ...
        {"path": "sounds/時間つぶし3.wav", "subtitle": "質問はもうないのか？ つまんねぇな。まぁいい、特別に俺様の話を聞かせてやる。この世界にはな、二種類の人間しかいねぇん だ。俺様みたいに頂点に立つやつと、お前らみたいに下から見上げるやつだ。でもな、安心しろ。下にいるからこそ、上の景色に憧れられる。その憧れが、お前らを生かしてんだ。感謝の言葉は受け付けねぇからな。"}
    ],
    '1': [
