...
VIDEO_FULL2 = "Pumkin-Center2Left.mov"
VIDEO_FULL4 = "Pumkin-Left2Center.mov"
VIDEO_FULL3 = "Pumpkin-Left.mov"
VIDEO_FULL5 = "Pumkin-Center2Right.mov"
VIDEO_FULL6 = "Pumkin-Right.mov"
VIDEO_FULL7 = "Pumkin-Right2Center.mov"
...
# ==== 共通描画関数(アルファチャンネル対応) ====
def draw_video(screen, cap, size, dx, dy, frame_idx):
...
def draw_video_fullscreen(screen, frame, size):
    frame = cv2.cvtColor(frame, cv2.COLOR_BGR2RGBA)
    frame = cv2.resize(frame, size)
    surf = pygame.image.frombuffer(frame.tobytes(), frame.shape[1::-1], "RGBA")
    surf = surf.convert_alpha()
...
def main():
    ...
    while True:
        ...
        if state == "normal":
            ...
            draw_video(screen, cap_main, (w, h), dx_main, dy_main, current_main)
        elif state == "full3":
            ...
            draw_video(screen, cap_full3, (w, h), dx_f3, dy_f3, current_f3)
        elif state == "full6":
            ...
            draw_video(screen, cap_full6, (w, h), dx_f6, dy_f6, current_f6)
        elif state == "full2":
            ...
            if not ret:
                ...
                draw_video_fullscreen(screen, frame, (w, h))
        elif state == "full4":
