...
class PumpkinTalk:
    ...
    def listen_and_transcribe(self):
        ...
        print("録音を開始するにはEnterキーを押してください...")
        
        try:
            while True:
                input("Enterキーを押してください...")  # Enterキーで録音開始/停止
                
                if not self.is_recording:
                    # 開始
                    self.start_recording()
                    print("録音中... Enterキーを押して停止")
                else:
                    # 停止
